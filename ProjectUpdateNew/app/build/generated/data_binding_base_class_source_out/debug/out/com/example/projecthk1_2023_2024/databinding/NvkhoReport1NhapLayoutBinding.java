...
public final class NvkhoReport1NhapLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private NvkhoReport1NhapLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static NvkhoReport1NhapLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NvkhoReport1NhapLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.nvkho_report1_nhap_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NvkhoReport1NhapLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NvkhoReport1NhapLayoutBinding((ConstraintLayout) rootView, backHome, consInfPNhap,
