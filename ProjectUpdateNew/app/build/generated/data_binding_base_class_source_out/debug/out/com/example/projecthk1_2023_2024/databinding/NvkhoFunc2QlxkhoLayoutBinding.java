...
public final class NvkhoFunc2QlxkhoLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private NvkhoFunc2QlxkhoLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static NvkhoFunc2QlxkhoLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NvkhoFunc2QlxkhoLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.nvkho_func2_qlxkho_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NvkhoFunc2QlxkhoLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NvkhoFunc2QlxkhoLayoutBinding((ConstraintLayout) rootView, backHome, consInfPNhap,
          consText, dspxMoi, funcSearch, icSearch, seach, textNhap);
    }
