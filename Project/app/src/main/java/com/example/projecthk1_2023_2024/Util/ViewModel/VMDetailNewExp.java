...
public class VMDetailNewExp extends Application {
    ...
    Pair<String, ExpBatch> exp_batchPair2;
    Pair<String, ProductBatch> batchPair2;
    Pair<String, Zone> zonePair2;

    public VMDetailNewExp(Pair<String, Product> productPair2, Pair<String, Shelf> shelfPair2, Pair<String, ExpBatch> exp_batchPair2, Pair<String, ProductBatch> batchPair2, Pair<String, Zone> zonePair2) {
    ...
    public Pair<String, ExpBatch> getExp_batchPair2() {
        return exp_batchPair2;
    }

    public void setExp_batchPair2(Pair<String, ExpBatch> exp_batchPair2) {
        this.exp_batchPair2 = exp_batchPair2;
    }
