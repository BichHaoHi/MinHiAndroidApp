...
public class VMDetailNewImp extends Application {
    ...
    Pair<String, ImportBatch> importPair3;

    public VMDetailNewImp(Pair<String, Product> productPair3, Pair<String, ProductBatch> batchPair3, Pair<String, ImportBatch> importPair3) {
    ...
    public Pair<String, ImportBatch> getImportPair3() {
        return importPair3;
    }

    public void setImportPair3(Pair<String, ImportBatch> importPair3) {
        this.importPair3 = importPair3;
    }
}